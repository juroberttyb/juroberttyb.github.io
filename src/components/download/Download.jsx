...
const DownloadButton = ({ fileUrl, fileName }) => {
  ...
  return (
    ...
    //     {fileName}
    // </button>
    <a href="https://www.dropbox.com/scl/fi/ornw60wyiz01hcm5v2zvc/ohana.zip?rlkey=oilrmjywxxk7x1vjsrsgfp15x&st=lpbkvt0d&dl=1" download="ohana.zip" id='download_button' className='button'>
        {fileName}
    </a>
  );
};
